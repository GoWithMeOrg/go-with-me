...
export type Query = {
    ...
    findCompanion: CompanionsResponse;
...
export type LocationByIdQuery = {
    ...
    locationById: {
        ...
        _id: string;
        type: string;
        geometry: { __typename: 'LocationGeometry'; coordinates: Array<number>; type: string };
        properties: {
            __typename: 'LocationProperties';
            address: string | null;
            ownerId: string;
...
export type LocationByOwnerIdQuery = {
    __typename: 'Query';
    locationByOwnerId: {
        __typename: 'Location';
        _id: string;
...
export type PermissionsQuery = {
    ...
    permissions: Array<{
        ...
        isActive: boolean;
        name: string;
        resource: { __typename: 'Resource'; name: string };
    }>;
};
...
export type GetRolesQuery = {
    ...
    roles: Array<{
        ...
        permissions: Array<{
            ...
            description: string | null;
            name: string;
            resource: { __typename: 'Resource'; _id: string; name: string; slug: string };
        }>;
    }>;
};
...
export type RoleByUserIdQuery = {
    __typename: 'Query';
    roleByUserId: {
        __typename: 'User';
        roles: Array<{ __typename: 'Role'; name: string }> | null;
    } | null;
};
...
export type RoleByNameQuery = {
    __typename: 'Query';
    roleByName: { __typename: 'Role'; _id: string; name: string };
};
...
export type UserProfileQuery = {
    ...
    userProfile: {
        __typename: 'UserProfile';
        tag: { __typename: 'Tag'; tags: Array<string>; _id: string } | null;
        category: { __typename: 'Category'; _id: string; categories: Array<string> } | null;
        interest: { __typename: 'Interest'; _id: string; interests: Array<string> } | null;
        location: {
            __typename: 'Location';
            _id: string;
            geometry: { __typename: 'LocationGeometry'; coordinates: Array<number> };
            properties: { __typename: 'LocationProperties'; address: string | null };
        } | null;
        user: {
            __typename: 'User';
            _id: string;
...
export type FindByEmailOrNameQuery = {
    __typename: 'Query';
    findByEmailOrName: Array<{
        __typename: 'User';
        _id: string;
        firstName: string;
        lastName: string;
...
export const GetCompanionRequestsDocument = {
    kind: 'Document',
    definitions: [
        {
...
} as unknown as DocumentNode<GetCompanionRequestsQuery, GetCompanionRequestsQueryVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'locationById' } },
                    type: {
                        kind: 'NonNullType',
                        type: { kind: 'NamedType', name: { kind: 'Name', value: 'ID' } },
                    },
...
} as unknown as DocumentNode<LocationByIdQuery, LocationByIdQueryVariables>;
export const LocationByOwnerIdDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'LocationByOwnerId' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
...
} as unknown as DocumentNode<LocationByOwnerIdQuery, LocationByOwnerIdQueryVariables>;
...
export const RoleByUserIdDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'RoleByUserId' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'userId' } },
...
} as unknown as DocumentNode<RoleByUserIdQuery, RoleByUserIdQueryVariables>;
export const RoleByNameDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
...
export const SearchResourcesDocument = {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'SearchResources' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
...
} as unknown as DocumentNode<SearchResourcesQuery, SearchResourcesQueryVariables>;
    ...
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'FindByEmailOrName' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'query' } },
...
} as unknown as DocumentNode<FindByEmailOrNameQuery, FindByEmailOrNameQueryVariables>;
