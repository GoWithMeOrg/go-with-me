...
export type AcceptInvitationMutation = { __typename: 'Mutation', acceptInvitation: { __typename: 'Invited', _id: string, status: string } };
...
export type DeclineInvitationMutation = { __typename: 'Mutation', declineInvitation: { __typename: 'Invited', _id: string, status: string } };
...
export type GetInvitationQuery = { __typename: 'Query', getInvitation: Array<{ __typename: 'Invited', _id: string, status: string, invitation: { __typename: 'Invitation', _id: string, event: { __typename: 'Event', _id: string, name: string, image: string | null, time: string | null, startDate: unknown, location: { __typename: 'Location', type: string, geometry: { __typename: 'LocationGeometry', coordinates: Array<number> }, properties: { __typename: 'LocationProperties', address: string | null } } | null, organizer: { __typename: 'User', firstName: string, _id: string } }, sender: { __typename: 'User', _id: string, firstName: string } } | null, user: { __typename: 'User', _id: string } }> };
