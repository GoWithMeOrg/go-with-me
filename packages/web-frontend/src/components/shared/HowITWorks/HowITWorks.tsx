      ...
      <div className={classes.cardsWorkList}>
        <CardWork
          ...
          description={
            ...
            <p>
              Организаторы могут легко создавать публичные мероприятия, которые открыты
              для&nbsp;всех желающих. От концертов до&nbsp;общественных собраний, поделитесь
              своим&nbsp;событием со всем миром. Привлеките посетителей с помощью интерактивных
              функций, таких как обсуждение мероприятия и&nbsp;обмен фотографиями.
            </p>
          }
          picture={<CreateEvent />}
        />
        <CardWork
          ...
          description={
            ...
            <p>
              ...
              избранных приглашенных. Будь то&nbsp;празднование дня рождения или частная встреча,
              сделайте свое мероприятие эксклюзивным. Контролируйте доступ к&nbsp;мероприятию с
              помощью настраиваемых параметров приглашений и управления списком гостей.
            </p>
          }
        ...
        <CardWork
          ...
          description={
            ...
            <p>
              ...
              на&nbsp;выходные до международных экспедиций. Изучайте направления, создавайте
              маршруты и приглашайте друзей. Обменивайтесь с&nbsp;попутчиками деталями поездки
              и&nbsp;координируйте действия.
            </p>
          }
        ...
        <CardWork
          ...
          description={
            ...
            // </p>
            <p>
              Клиенты могут найти интересные мероприятия поблизости от своего местонахождения.
              Концерты, семинары или общественные мероприятия - просматривайте, регистрируйтесь и
              присоединяйтесь к&nbsp;веселью. Оставайтесь в курсе предстоящих событий благодаря
              персональным рекомендациям и уведомлениям, основанным на ваших интересах.
            </p>
          }
