...
import { CREATE_ROLE, DELETE_ROLE, GET_ROLES, RoleManagement, UPDATE_ROLE } from './RoleManagement';
...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'The default view showing the role management interface with existing roles and the ability to create new ones.',
      },
    },
  },
};
...
export const WithManyRoles: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'A view with many roles to demonstrate how the component handles a larger dataset and grid layout.',
      },
    },
  },
};
